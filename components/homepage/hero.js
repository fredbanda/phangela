        ...
        <div className="text-center ">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200 sm:text-5xl md:text-6xl">
            <span className="block xl:inline">
              <span className="mb-1 block">Craft ATS-Ready CVs / Résumés.</span>
              <span className="bg-gradient-to-r from-indigo-400 to-pink-600 bg-clip-text text-transparent">
                Get past filters and onto shortlists.
              </span>
            </span>
            <div className="mt-2">
              Stand out instantly{' '}
              <span className="relative mt-3 whitespace-nowrap text-blue-600">
                ...
                <span className="relative">with AI support. 🚀</span>
              </span>
            </div>
          </h1>
          <p className="mx-auto mt-3 max-w-xl text-lg text-gray-500 dark:text-slate-400 sm:mt-5 md:mt-5">
            The AI Resume Builder designed to help you stand out with
            professional, ATS-ready resumes—completely free, forever. Helping
            our unemployed South Africans with one CV at a time.
          </p>
