...
export default function PreviewCard() {
  ...
  if (!resume) {
    return (
      <div className="w-full flex items-center justify-center h-64 rounded-xl border border-dashed border-gray-300 text-gray-500">
  ...
  return (
    <>
      ...
      <div
        className="preview-card w-full rounded-xl border-t-[20px] transition-all duration-200 h-screen overflow-y-auto"
        style={{
